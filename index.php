...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex justify-content-center align-items-center" style="background-image: url('img-Student-Resources-Low-Income-Graduate-Students.png');">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="Graduation.jpg" style="height:400px;" class="img-fluid" alt="">
          </div>
